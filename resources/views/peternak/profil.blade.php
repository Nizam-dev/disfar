    ...
    <form action="{{url('peternak/profil')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="text-center mb-3">
                ...
                <div class="form-group basic">
                    <div class="input-wrapper">
                        <label class="label" for="no_hp">Username</label>
                        <input type="text" class="form-control"
                            value="{{ auth()->user()->username }}" name="username"
                            id="username" placeholder="No Hp">
                        <i class="clear-input">
                            <ion-icon name="close-circle"></ion-icon>
                        </i>
                    </div>
                ...
                <div class="form-group basic">
                    <div class="input-wrapper">
                        <label class="label" for="no_hp">Dusun</label>
                        <input type="text" class="form-control"
                            value="{{ auth()->user()->dusun }}" name="dusun"
                            id="dusun" placeholder="No Hp">
                        <i class="clear-input">
                            <ion-icon name="close-circle"></ion-icon>
                        </i>
                    </div>
